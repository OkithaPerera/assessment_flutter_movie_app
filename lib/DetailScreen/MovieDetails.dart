...
import 'package:assessment_flutter_movie_app/RepeatedFunction/sliderlist.dart';
import 'package:assessment_flutter_movie_app/apikey/apikey.dart';
...
import 'package:assessment_flutter_movie_app/SqfLitelocalstorage/NoteDbHelper.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';

import '../RepeatedFunction/reviewui.dart';

class MovieDetails extends StatefulWidget {
  final id; // Marked as final
  MovieDetails({required this.id}); // Using required for named parameters
  @override
